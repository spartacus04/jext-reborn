...
<p>You can now create a class that implements the <a href="../-j-e-x-t--reborn/me.spartacus04.jext.discs.sources/-disc-source/index.html">DiscSource</a> interface: </p>
...
<br>
<p>Finally, you can register the disc source by using the <a href="../-j-e-x-t--reborn/me.spartacus04.jext.discs/-disc-manager/index.html">DiscManager</a>:</p>
...
<p>If you want to play the disc with a custom method, you can create a class that implements use the <a href="../-j-e-x-t--reborn/me.spartacus04.jext.discs/-disc/index.html">Disc</a> object:</p>
