...
<div
	class="flex flex-col items-center p-2 bg-primary-500 rounded-bl-lg border-white border-l border-b fixed z-10 right-0 h-fit {marginToggled
		? 'mr-2'
		: ''}"
>
	{#if indexOpen}
	...
	<button on:click={toggleIndex} class="w-full">
		{#if indexOpen}
			<svg
				...
				viewBox="0 0 448 512"
				class="fill-white h-8 cursor-pointer rotate-180 w-full"
			>
				<path
		...
		{:else}
			<svg
				xmlns="http://www.w3.org/2000/svg"
				viewBox="0 0 448 512"
				class="fill-white h-5 cursor-pointer w-full"
			>
				<path
					d="M201.4 374.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 306.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z"
				></path>
...
<svelte:head>
	...
	<meta
		name="description"
		content="Web GUI for the Jext Reborn Minecraft plugin. Here you can check the documentation with ease"
	/>
</svelte:head>
