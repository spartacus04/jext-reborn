...
<p>A permission integration is used to determine if a disc can play or if a jukebox gui can open in a certain area.</p>
<p>They are used by plugins like Griefprevention and WorldGuard. A plugin can register it's own integration by doing the following: </p>
<br>
...
<p>You can now create a class that implements the <a href="../-j-e-x-t--reborn/me.spartacus04.jext.integrations/-integration/index.html">Integration</a> interface: </p>
...
<p>Finally, you can register your integration by using the <a href="../-j-e-x-t--reborn/me.spartacus04.jext.integrations/-integrations-manager/index.html">IntegrationManager</a> :</p>
