<script lang="ts">
	...
	import { addDownloadQueuePack, downloaderLine, startDownloadQueue, type CommunityPack } from '$lib/downloader/downloader';
...
{:then packs} 
    ...
    {:else} 
        ...
        <div class="grid p-4 pt-2 gap-2 grid-cols-1 xs:grid-cols-2 lg:grid-cols-1 flex-grow overflow-y-auto overflow-x-hidden">
