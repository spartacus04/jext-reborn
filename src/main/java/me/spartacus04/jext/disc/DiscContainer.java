...
import me.spartacus04.jext.config.ConfigDiscData;
...
public class DiscContainer {
  ...
  public DiscContainer(ConfigDiscData configDiscData) {
    ...
    this.customModelData = configDiscData.getIntegerData(ConfigDiscData.Path.MODEL_DATA);
    this.creeperDrop = configDiscData.getBooleanData(ConfigDiscData.Path.CREEPER_DROP);
