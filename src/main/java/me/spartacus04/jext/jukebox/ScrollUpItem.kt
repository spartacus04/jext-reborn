...
/**
 * The ScrollUpItem class represents the item that is used to scroll up through the items in the jukebox GUI.
 *
 * @property player The "player" property represents the player who is scrolling through the items in the jukebox GUI.
 * @constructor Creates a ScrollUpItem object.
 */
internal class ScrollUpItem(private val player: Player) : ScrollItem(-1) {
    /**
