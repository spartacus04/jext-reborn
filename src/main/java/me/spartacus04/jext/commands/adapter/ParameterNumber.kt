 ...
 */
internal class ParameterNumber internal constructor(required: Boolean, vararg suggestedValues: Number) : Parameter(required) {
    private val stringValues: MutableList<String> = ArrayList()
